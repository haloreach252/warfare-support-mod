package com.haloreach252.warfareadditions.block.container;
...
public class ContainerFissionGenerator extends Container{

	private final TileEntityFissionGenerator tileentity;
	private int energy, cookTime;
	
	public ContainerFissionGenerator(InventoryPlayer player, TileEntityFissionGenerator tileentity) {
...
/*
Making space for easier editing
