package com.haloreach252.warfareadditions.block.gui;
...
public class GuiFissionGenerator extends GuiContainer{

	private static final ResourceLocation TEXTURES = new ResourceLocation(Reference.MOD_ID + ":textures/gui/fission_generator.png");
	private final InventoryPlayer player;
	private final TileEntityFissionGenerator tileentity;
	
	public GuiFissionGenerator(InventoryPlayer player, TileEntityFissionGenerator tileentity) {
		super(new ContainerFissionGenerator(player, tileentity));
		this.player = player;
